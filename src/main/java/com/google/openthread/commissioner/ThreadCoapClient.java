...
/**
 * * A Commissioner Coap client that can send Thread-specific management commands to a Border Agent
 * (BA), for CCM or non-CCM networks. It can generate signed messages, by using a Token.
 */
public class ThreadCoapClient extends CoapClient {
   ...
   */
  public CoapResponse sendTMFRequest(final String uri, TLVset tlvs)
      throws IOException, CoseException, ConnectorException {
    logger.trace(
        "sendTMFRequest(Uri={},TLVs={},COM_TOK={},COM_TOK_SIG={},udpTx={},seq={})",
        uri,
        tlvs,
        doIncludeCOM_TOK,
        doIncludeCOM_TOK_SIG,
        doUDP_TX_Encapsulation,
        signingSequenceNumber);

    // sign URIs and TLVs with COM_TOK_SIG
    if (doIncludeCOM_TOK_SIG) signCoap(uri, tlvs);
   ...
   * @return
   */
  public CoapResponse sendCOMM_PET_req(String commissionerId)
      throws IOException, CoseException, ConnectorException {
